export default {
  ...
  response: {
    ...
    NoOpenAIAPIKey: 'PuerHub API Key 为空，请添加后使用',
    ...
    AgentRuntimeError: 'PuerHub AI 语言模型运行时执行出错，请根据以下信息排查或重试',
    /* eslint-enable */
  },
  stt: {
  ...
  unlock: {
    apikey: {
      ...
      OpenAI: {
        addProxyUrl: '添加 PuerHub AI 中继地址',
        description:
          '输入你的 PuerHub AI API Key 即可开始会话。您可以到 https://ai.puerhub.xyz 获取',
        title: '使用 PuerHub AI API Key',
      },
      Zhipu: {
